...
const Navbar = () => {
    ...
    return (
        <div className="flex md:flex-row flex-col-reverse justf=ify-between mb-[35px] gap-6">
            Navbar
            ...
            bg-[#1c1c24] rounded-[100px]">
                ...
                />
                <div className="w-[72px] h-full rounded-[20px] bg-[#4acd8d]
            ...
            <div className="hidden md:flex flex-row justify-end gap-4">
                ...
                <Link to="/profile">
                    ...
                    items-center cursor-pointer">
                        <img src={thirdweb} alt="user" className="h-[60%] w-[60%] object-contain" />
                    </div>
                </Link>
            </div>
            <div className="md:hidden flex flex-row justify-between items-center relative">
                <div className="w-[40px] h-[40px] rounded-[10px] bg-[#2c2f32] flex justify-center 
                    items-center cursor-pointer">
                    <img src={thirdweb} alt="user" className="h-[60%] w-[60%] object-contain" />
                </div>
                <img 
